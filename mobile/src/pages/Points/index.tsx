...
import { Feather as Icon, Entypo as Emoji } from "@expo/vector-icons";
import {
  View,
  StyleSheet,
  TouchableOpacity,
    ...
    <SafeAreaView style={{ flex: 1 }}>
      <View style={styles.container}>
        ...
        <View style={styles.containerTitle}>
          <Emoji name="emoji-happy" size={20} />
      ...
      <Text style={styles.itemsContainerTitle}>
        Selecione quais ítens deseja descartar:
      </Text>
